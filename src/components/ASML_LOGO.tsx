  ...
  return (
    <section className="absolute">
      {/* <article className="logo-main"> 
          ...
          */}
      <article className="mx-4 my-0 flex px-0 py-2 caret-transparent">
        ...
        <div className="mr-2 p-1 text-white">
          ...
          <div className="select-none pt-[2px] text-[0.75rem] font-semibold">2.4.0</div>
          {/* <div className="logo-version">2.4.0</div> */}
        </div>
        <div className="h-10 w-2 border-l-[1px] border-solid border-[#808080]"></div>
      </article>
    </section>
  );
};
